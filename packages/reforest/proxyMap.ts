/** Forked from valtio/utils to add computed support: https://github.com/pmndrs/valtio/blob/main/src/utils/proxyMap.ts */
...
export function proxyMap<K, V>(
  ...
  // @ts-ignore
  const map: InternalProxyMap<K, V> = proxyWithComputed(
    {
